      ...
      <div className="py-16">
        <div className="flex flex-col md:flex-row justify-between mb-4 items-center space-x-0 md:space-x-4">
          ...
          <select
            ...
            className="border-2 border-[#E2D609] outline-none bg-transparent text-[#E2D609] px-4 md:px-8 py-2 mt-4 md:mt-0 rounded-full w-full md:w-auto"
          >
            <option className="bg-gray-700 text-amber-50" value="">
              Select Year
            </option>
            {[2024, 2023, 2022, 2021, 2020, 2019].map((year: number) => (
              <option
                className="bg-amber-700 hover:bg-gray-700 hover:text-amber-50"
                value={year}
                key={year}
              >
                {year}
